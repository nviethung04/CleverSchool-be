...
type BaseResponse struct {
	...
	Error         string                 `protobuf:"bytes,4,opt,name=error,proto3" json:"error,omitempty"` // thêm field lỗi nếu có
...
const file_base_response_proto_rawDesc = "" +
	"\n" +
	"\x13base_response.proto\x12\x04prot\x1a\x19google/protobuf/any.proto\"|\n" +
	"\fBaseResponse\x12\x12\n" +
	"\x04code\x18\x01 \x01(\x05R\x04code\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12(\n" +
	"\x04data\x18\x03 \x01(\v2\x14.google.protobuf.AnyR\x04data\x12\x14\n" +
	"\x05error\x18\x04 \x01(\tR\x05errorB\x16Z\x14be-cleverschool/protb\x06proto3"

var (
	file_base_response_proto_rawDescOnce sync.Once
	file_base_response_proto_rawDescData []byte
)

func file_base_response_proto_rawDescGZIP() []byte {
	file_base_response_proto_rawDescOnce.Do(func() {
		file_base_response_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_base_response_proto_rawDesc), len(file_base_response_proto_rawDesc)))
	})
	return file_base_response_proto_rawDescData
}

var file_base_response_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_base_response_proto_goTypes = []any{
	(*BaseResponse)(nil), // 0: prot.BaseResponse
	(*anypb.Any)(nil),    // 1: google.protobuf.Any
}
var file_base_response_proto_depIdxs = []int32{
	1, // 0: prot.BaseResponse.data:type_name -> google.protobuf.Any
...
func file_base_response_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_base_response_proto_rawDesc), len(file_base_response_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
