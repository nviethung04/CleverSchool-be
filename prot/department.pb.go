...
func (x *Department) GetStatus() bool {
	if x != nil {
		return x.Status
	}
	return false
...
func (x *DepartmentListResponse) GetTotalCount() int64 {
	if x != nil {
		return x.TotalCount
	}
	return 0
...
const file_department_proto_rawDesc = "" +
	"\n" +
	"\x10department.proto\x12\x04prot\"\xa8\x01\n" +
	"\n" +
	"Department\x12\x0e\n" +
	...
	"\x06status\x18\x06 \x01(\bR\x06status\"m\n" +
...
var file_department_proto_goTypes = []any{
	(*Department)(nil),             // 0: prot.Department
	(*DepartmentListResponse)(nil), // 1: prot.DepartmentListResponse
}
var file_department_proto_depIdxs = []int32{
	0, // 0: prot.DepartmentListResponse.departments:type_name -> prot.Department
