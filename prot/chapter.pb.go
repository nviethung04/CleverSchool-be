...
type Chapter struct {
	...
	Headings      []*Heading             `protobuf:"bytes,14,rep,name=headings,proto3" json:"headings,omitempty"`
...
func (x *Chapter) GetTarget() string {
	if x != nil {
		return x.Target
	}
	return ""
...
func (x *Chapter) GetHeadings() []*Heading {
	if x != nil {
		return x.Headings
	}
	return nil
...
type ChapterRequest struct {
	...
	Headings      []*Heading             `protobuf:"bytes,13,rep,name=headings,proto3" json:"headings,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ChapterRequest) GetTime() int32 {
	if x != nil {
		return x.Time
	}
	return 0
...
func (x *ChapterRequest) GetTarget() string {
	if x != nil {
		return x.Target
	}
	return ""
...
func (x *ChapterRequest) GetHeadings() []*Heading {
	if x != nil {
		return x.Headings
	}
	return nil
...
const file_chapter_proto_rawDesc = "" +
	"\n" +
	"\rchapter.proto\x12\x04prot\x1a\flesson.proto\x1a\rheading.proto\"\xae\x03\n" +
	"\aChapter\x12\x0e\n" +
	...
	"\n" +
	"program_id\x18\v \x01(\x03R\tprogramId\x12\x12\n" +
	"\x04time\x18\f \x01(\x05R\x04time\x12\x16\n" +
	"\x06target\x18\r \x01(\tR\x06target\x12)\n" +
	"\bheadings\x18\x0e \x03(\v2\r.prot.HeadingR\bheadings\"#\n" +
	...
	"\x13ListChaptersRequest\"\xf7\x02\n" +
	...
	"\fobject_title\x18\b \x01(\tR\vobjectTitle\x12\x1d\n" +
	"\n" +
	"program_id\x18\t \x01(\x03R\tprogramId\x12\x12\n" +
	"\x04time\x18\n" +
	" \x01(\x05R\x04time\x12\x16\n" +
	"\x06target\x18\v \x01(\tR\x06target\x12)\n" +
	"\bheadings\x18\r \x03(\v2\r.prot.HeadingR\bheadings\"\"\n" +
	...
	"\alessons\x18\x01 \x03(\v2\x10.prot.LessonSortR\alessonsB\x16Z\x14be-cleverschool/protb\x06proto3"
...
var file_chapter_proto_goTypes = []any{
	...
	(*Heading)(nil),             // 10: prot.Heading
}
var file_chapter_proto_depIdxs = []int32{
	9,  // 0: prot.Chapter.lessons:type_name -> prot.LessonInfo
	10, // 1: prot.Chapter.headings:type_name -> prot.Heading
	0,  // 2: prot.ChapterResponse.chapter:type_name -> prot.Chapter
	9,  // 3: prot.ChapterRequest.lessons:type_name -> prot.LessonInfo
	10, // 4: prot.ChapterRequest.headings:type_name -> prot.Heading
	0,  // 5: prot.ChaptersResponse.chapters:type_name -> prot.Chapter
	7,  // 6: prot.ChapterLessonSort.lessons:type_name -> prot.LessonSort
