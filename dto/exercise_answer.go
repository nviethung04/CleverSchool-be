...
type ExerciseAnswerFillInBlank struct {
...
type ExerciseAnswerPosition struct {
...
type ExerciseAnswerMatching struct {
...
type ExerciseAnswerLabeling struct {
...
type ExerciseAnswerGroup struct {
	AnswerID       int64   `json:"answer_id"`
...
type ExerciseAnswerManual struct {
