...
CREATE INDEX IF NOT EXISTS idx_zoom_meetings_deleted_at ON zoom_meetings(deleted_at);

-- Create unique constraint for zoom_meeting_id
CREATE UNIQUE INDEX IF NOT EXISTS idx_zoom_meetings_zoom_id 
ON zoom_meetings(zoom_meeting_id) WHERE deleted_at IS NULL;