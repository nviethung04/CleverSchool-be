...
func modelToProtoLessonPlanPart(part *models.LessonPlanPart) *prot.LessonPlanPart {
	...
	return &prot.LessonPlanPart{
		...
		Title:        part.Title,
		Tag:          part.Tag,
		CoverImage:   utils.StaticURL(part.CoverImageInfo.Path, models.ResolveStorageDisk(part.CoverImageInfo.Disk)),
		SortPosition: int32(part.SortPosition),
		Time:         part.Time,
		IsClasswork:  part.IsClasswork,
		FileType:     part.FileType,
		Link:         utils.StaticURL(part.LinkInfo.Path, models.ResolveStorageDisk(part.LinkInfo.Disk)),
