...
type User struct {
	...
	MemberType           string         `gorm:"column:member_type;default:internal;not null" json:"member_type"`
	IsIndependentStudent bool           `gorm:"column:is_independent_student;default:false" json:"is_independent_student"`
	IsFailedSubject      bool           `gorm:"column:is_failed_subject;default:false" json:"is_failed_subject"`
}
